...
#' strongest landfall, or generate a data frame containing information regarding
#' its track and when and where it was over land or sea.
#'
...
#' @return method "landfall.check" returns TRUE/FALSE indicating whether storm
#' made landfall in continental US. Method "landfall.data" returns data frame
#' regarding storm's landfall status at specific times and position. Method
#' "landfall.strongest" returns dataframe of storm's strongest landfall along
#' with position and max.wind
#' @examples
...
#' @export
landfall <- function( storm, year, dat, method=c("landfall.check", "landfall.data", "landfall.strongest") ){
    ...
    # method landfall.check returns TRUE on first occurrence of landfall
    ...
    # method landfall.data returns data regardless of landfall or not
    ...
    # method landfall.strongest returns data if storm made landfall
